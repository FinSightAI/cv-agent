...
export const metadata: Metadata = {
  ...
  // Private tool — kept out of every index. app/robots.ts disallows crawling
  // and middleware.ts requires a password; this is the tag that binds a crawler
  // which somehow already has the HTML.
