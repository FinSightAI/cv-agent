export const dictionary = {
  he: {
    ...
    "nav.settings": "העדפות",
    "nav.stats": "אנליטיקס",
    "nav.offerCompare": "השוואת הצעות",
    "compare.title": "השוואת הצעות עבודה",
    "compare.desc": "הכנס 2-4 הצעות, הגדר עדיפויות, קבל המלצה מנומקת",
    "compare.addOffer": "הוסף הצעה",
    "compare.company": "חברה",
    "compare.role": "תפקיד",
    "compare.salary": "שכר בסיס",
    "compare.bonus": "בונוס שנתי %",
    "compare.equity": "equity (שנתי)",
    "compare.wfh": "ימי עבודה מהבית",
    "compare.growth": "פוטנציאל צמיחה",
    "compare.culture": "תרבות",
    "compare.priorities": "העדיפויות שלי",
    "compare.compare": "השווה הצעות",
    "compare.comparing": "מנתח...",
    "compare.recommendation": "המלצת AI",
    "compare.longTerm": "מבט לטווח ארוך",
    "compare.negotiate": "טיפ למשא ומתן",
    "compare.totalComp": "שכר כולל",
    "compare.score": "ניקוד השוואה",
    "compare.perOffer": "ניתוח לפי הצעה",
    "compare.strength": "יתרון",
    "compare.risk": "סיכון נסתר",
    "nav.help": "מדריך",
    ...
    "jobs.new.bulkLabel": "קישורים (שורה לכל משרה)",
    "jobs.new.bulkPlaceholder": "https://www.linkedin.com/jobs/view/...\nhttps://www.linkedin.com/jobs/view/...",
    "jobs.new.bulkAdd": "הוסף הכל",
    "jobs.new.bulkAdding": "מוסיף...",
    ...
    "rejection.title": "ניתוח מייל דחייה",
    "rejection.desc": "AI קורא בין השורות — האם הדלת פתוחה? כדאי להשיב?",
    "rejection.paste": "הדבק את מייל הדחייה",
    "rejection.analyze": "נתח",
    "rejection.analyzing": "קורא...",
    "rejection.shouldReply": "כדאי להשיב",
    "rejection.shouldNotReply": "אין טעם להשיב",
    "rejection.doorOpen": "הדלת פתוחה",
    "rejection.doorClosed": "הדלת סגורה",
    "rejection.replyDraft": "טיוטת תשובה",
    "rejection.type.form_letter": "מכתב סטנדרטי",
    ...
    // 30-60-90 Day Plan
    "plan.title": "תכנית 30-60-90 יום",
    "plan.desc": "תכנית ספציפית לתפקיד שתרשים כל מראיין — מה תעשה ב-30, 60, ו-90 הימים הראשונים",
    "plan.run": "צור תכנית",
    "plan.regenerate": "צור מחדש",
    "plan.running": "מכין תכנית...",
    "plan.week1": "שבוע ראשון — עדיפויות",
    "plan.summary": "סיכום מנהלים",
    "plan.copy": "העתק תכנית מלאה",
    "plan.download": "הורד כ-.txt",
    "plan.questions": "שאלות לשאול בראיון",
    "plan.success": "מדד הצלחה",

    // JD Decoder
    "jd.title": "פענוח ה-JD",
    "jd.desc": "מה החברה באמת רוצה — מעבר למה שכתוב",
    "jd.run": "פענח את ה-JD",
    "jd.running": "קורא בין השורות...",
    "jd.verdict": "פסיקה",
    "jd.real": "מה שהם באמת רוצים",
    "jd.stated": "מה שכתבו",
    "jd.actual": "מה שצריך",
    "jd.redflags": "ביטויים לשים לב",
    "jd.context": "קונטקסט נסתר",
    ...
    "launch.subtitle": "בחר משרות, לחץ שיגור — Turbo Apply רץ על הכל במקביל",
    "launch.smartSelect": "בחירה חכמה (70+)",
    "launch.selectAll": "בחר הכל",
    "launch.clearAll": "נקה הכל",
    "launch.selected": "{n} נבחרו",
    "launch.noJobs": "אין משרות זמינות להגשה",
    "launch.noJobs.desc": "הוסף משרות בעמוד 'משרות' כדי להתחיל",
    "launch.launch": "🚀 שגר {n} משרות",
    "launch.launchOne": "🚀 שגר משרה",
    "launch.noResume": "העלה קורות חיים תחילה",
    "launch.filterReady": "מוכנות בלבד",
    "launch.filterAll": "כל המשרות",
    "launch.score": "ציון",
    "launch.noScore": "ללא ניתוח",
    "batch.title": "Batch Turbo Apply",
    "batch.preparing": "מכין {n} משרות...",
    "batch.done": "הכל מוכן!",
    "batch.failed": "נכשל",
    "batch.downloading": "יוצר קובץ...",
    "batch.opening": "פותח דפים...",
    "batch.step.tailor": "מתאים CV",
    "batch.step.letter": "כותב מכתב",
    "batch.step.done": "מוכן",
    "batch.step.failed": "נכשל",
    "batch.download": "הורד חבילה",
    "batch.openAll": "פתח כל הדפים",
    "batch.markApplied": "סמן כ'הוגש'",
    "batch.close": "סגור",
    "batch.progress": "{done}/{total} הושלמו",
    "batch.noUrl": "ללא לינק",
  },
  en: {
    "brand.name": "Jobos",
    ...
    "nav.stats": "Analytics",
    "nav.offerCompare": "Offer Comparison",
    "compare.title": "Compare Job Offers",
    "compare.desc": "Enter 2-4 offers, set your priorities, get a recommendation",
    "compare.addOffer": "Add offer",
    "compare.company": "Company",
    "compare.role": "Role",
    "compare.salary": "Base salary",
    "compare.bonus": "Annual bonus %",
    "compare.equity": "Equity (annual value)",
    "compare.wfh": "WFH days/week",
    "compare.growth": "Growth potential",
    "compare.culture": "Culture fit",
    "compare.priorities": "My priorities",
    "compare.compare": "Compare offers",
    "compare.comparing": "Analyzing...",
    "compare.recommendation": "AI Recommendation",
    "compare.longTerm": "Long-term view",
    "compare.negotiate": "Negotiation tip",
    "compare.totalComp": "Total comp",
    "compare.score": "Comparison score",
    "compare.perOffer": "Per-offer analysis",
    "compare.strength": "Key strength",
    "compare.risk": "Hidden risk",
    "nav.help": "Guide",
    ...
    "jobs.new.tab.bulk": "Multiple URLs",
    "jobs.new.urlLabel": "URL",
    "jobs.new.urlNote":
    ...
    "jobs.new.bulkLabel": "URLs (one per line)",
    "jobs.new.bulkPlaceholder": "https://www.linkedin.com/jobs/view/...\nhttps://www.linkedin.com/jobs/view/...",
    "jobs.new.bulkAdd": "Add all",
    "jobs.new.bulkAdding": "Adding…",
    ...
    // Rejection email analyzer
    "rejection.title": "Rejection Email Analyzer",
    "rejection.desc": "AI reads between the lines — is the door open? Worth replying?",
    "rejection.paste": "Paste the rejection email",
    "rejection.analyze": "Analyze",
    "rejection.analyzing": "Reading...",
    "rejection.shouldReply": "Worth replying",
    "rejection.shouldNotReply": "No point in replying",
    "rejection.doorOpen": "Door is open",
    "rejection.doorClosed": "Door is closed",
    "rejection.replyDraft": "Reply draft",
    "rejection.type.form_letter": "Form letter",
    ...
    // 30-60-90 Day Plan
    "plan.title": "30-60-90 Day Plan",
    "plan.desc": "A role-specific plan that impresses every interviewer — what you\'ll do in the first 30, 60, and 90 days",
    "plan.run": "Generate plan",
    "plan.regenerate": "Regenerate",
    "plan.running": "Building plan...",
    "plan.week1": "First week — priorities",
    "plan.summary": "Executive summary",
    "plan.copy": "Copy full plan",
    "plan.download": "Download as .txt",
    "plan.questions": "Questions to ask in interview",
    "plan.success": "Success metric",

    // JD Decoder
    "jd.title": "JD Decoder",
    "jd.desc": "What the company really wants — beyond what\'s written",
    "jd.run": "Decode the JD",
    "jd.running": "Reading between the lines...",
    "jd.verdict": "Verdict",
    "jd.real": "What they really want",
    "jd.stated": "What they wrote",
    "jd.actual": "What\'s actually needed",
    "jd.redflags": "Phrases to watch out for",
    ...
    "launch.title": "Launch Pad",
    "launch.subtitle": "Select jobs, hit launch — Turbo Apply runs on all of them in parallel",
    "launch.smartSelect": "Smart select (70+)",
    "launch.selectAll": "Select all",
    "launch.clearAll": "Clear",
    "launch.selected": "{n} selected",
    "launch.noJobs": "No jobs available to apply",
    "launch.noJobs.desc": "Add jobs on the Jobs page to get started",
    "launch.launch": "🚀 Launch {n} jobs",
    "launch.launchOne": "🚀 Launch job",
    "launch.noResume": "Upload your resume first",
    "launch.filterReady": "Ready only",
    "launch.filterAll": "All jobs",
    "launch.score": "Score",
    "launch.noScore": "No analysis",
    "batch.title": "Batch Turbo Apply",
    "batch.preparing": "Preparing {n} jobs...",
    "batch.done": "All done!",
    "batch.failed": "Failed",
    "batch.downloading": "Creating file...",
    "batch.opening": "Opening pages...",
    "batch.step.tailor": "Tailoring CV",
    "batch.step.letter": "Writing letter",
    "batch.step.done": "Done",
    "batch.step.failed": "Failed",
    "batch.download": "Download bundle",
    "batch.openAll": "Open all pages",
    "batch.markApplied": "Mark as applied",
    "batch.close": "Close",
